...
module tutorial01_mm_interconnect_0 (
		...
		output wire [2:0]  SEG_SEG_s1_address,                                    //                                      SEG_SEG_s1.address
		output wire        SEG_SEG_s1_write,                                      //                                                .write
		input  wire [31:0] SEG_SEG_s1_readdata,                                   //                                                .readdata
		output wire [31:0] SEG_SEG_s1_writedata,                                  //                                                .writedata
		output wire        SEG_SEG_s1_chipselect,                                 //                                                .chipselect
		output wire [2:0]  SEG_SWITCH_s1_address,                                 //                                   SEG_SWITCH_s1.address
		output wire        SEG_SWITCH_s1_write,                                   //                                                .write
		input  wire [31:0] SEG_SWITCH_s1_readdata,                                //                                                .readdata
	...
	wire  [31:0] seg_switch_s1_agent_m0_readdata;                                           // SEG_SWITCH_s1_translator:uav_readdata -> SEG_SWITCH_s1_agent:m0_readdata
	wire         seg_switch_s1_agent_m0_waitrequest;                                        // SEG_SWITCH_s1_translator:uav_waitrequest -> SEG_SWITCH_s1_agent:m0_waitrequest
	wire         seg_switch_s1_agent_m0_debugaccess;                                        // SEG_SWITCH_s1_agent:m0_debugaccess -> SEG_SWITCH_s1_translator:uav_debugaccess
	wire  [16:0] seg_switch_s1_agent_m0_address;                                            // SEG_SWITCH_s1_agent:m0_address -> SEG_SWITCH_s1_translator:uav_address
	wire   [3:0] seg_switch_s1_agent_m0_byteenable;                                         // SEG_SWITCH_s1_agent:m0_byteenable -> SEG_SWITCH_s1_translator:uav_byteenable
	wire         seg_switch_s1_agent_m0_read;                                               // SEG_SWITCH_s1_agent:m0_read -> SEG_SWITCH_s1_translator:uav_read
	wire         seg_switch_s1_agent_m0_readdatavalid;                                      // SEG_SWITCH_s1_translator:uav_readdatavalid -> SEG_SWITCH_s1_agent:m0_readdatavalid
	wire         seg_switch_s1_agent_m0_lock;                                               // SEG_SWITCH_s1_agent:m0_lock -> SEG_SWITCH_s1_translator:uav_lock
	wire  [31:0] seg_switch_s1_agent_m0_writedata;                                          // SEG_SWITCH_s1_agent:m0_writedata -> SEG_SWITCH_s1_translator:uav_writedata
	wire         seg_switch_s1_agent_m0_write;                                              // SEG_SWITCH_s1_agent:m0_write -> SEG_SWITCH_s1_translator:uav_write
	wire   [2:0] seg_switch_s1_agent_m0_burstcount;                                         // SEG_SWITCH_s1_agent:m0_burstcount -> SEG_SWITCH_s1_translator:uav_burstcount
	wire         seg_switch_s1_agent_rf_source_valid;                                       // SEG_SWITCH_s1_agent:rf_source_valid -> SEG_SWITCH_s1_agent_rsp_fifo:in_valid
	wire  [95:0] seg_switch_s1_agent_rf_source_data;                                        // SEG_SWITCH_s1_agent:rf_source_data -> SEG_SWITCH_s1_agent_rsp_fifo:in_data
	wire         seg_switch_s1_agent_rf_source_ready;                                       // SEG_SWITCH_s1_agent_rsp_fifo:in_ready -> SEG_SWITCH_s1_agent:rf_source_ready
	wire         seg_switch_s1_agent_rf_source_startofpacket;                               // SEG_SWITCH_s1_agent:rf_source_startofpacket -> SEG_SWITCH_s1_agent_rsp_fifo:in_startofpacket
	wire         seg_switch_s1_agent_rf_source_endofpacket;                                 // SEG_SWITCH_s1_agent:rf_source_endofpacket -> SEG_SWITCH_s1_agent_rsp_fifo:in_endofpacket
	wire         seg_switch_s1_agent_rsp_fifo_out_valid;                                    // SEG_SWITCH_s1_agent_rsp_fifo:out_valid -> SEG_SWITCH_s1_agent:rf_sink_valid
	wire  [95:0] seg_switch_s1_agent_rsp_fifo_out_data;                                     // SEG_SWITCH_s1_agent_rsp_fifo:out_data -> SEG_SWITCH_s1_agent:rf_sink_data
	wire         seg_switch_s1_agent_rsp_fifo_out_ready;                                    // SEG_SWITCH_s1_agent:rf_sink_ready -> SEG_SWITCH_s1_agent_rsp_fifo:out_ready
	wire         seg_switch_s1_agent_rsp_fifo_out_startofpacket;                            // SEG_SWITCH_s1_agent_rsp_fifo:out_startofpacket -> SEG_SWITCH_s1_agent:rf_sink_startofpacket
	wire         seg_switch_s1_agent_rsp_fifo_out_endofpacket;                              // SEG_SWITCH_s1_agent_rsp_fifo:out_endofpacket -> SEG_SWITCH_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> SEG_SWITCH_s1_agent:cp_valid
	wire  [94:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> SEG_SWITCH_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // SEG_SWITCH_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> SEG_SWITCH_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> SEG_SWITCH_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> SEG_SWITCH_s1_agent:cp_endofpacket
	wire  [31:0] seg_seg_s1_agent_m0_readdata;                                              // SEG_SEG_s1_translator:uav_readdata -> SEG_SEG_s1_agent:m0_readdata
	wire         seg_seg_s1_agent_m0_waitrequest;                                           // SEG_SEG_s1_translator:uav_waitrequest -> SEG_SEG_s1_agent:m0_waitrequest
	wire         seg_seg_s1_agent_m0_debugaccess;                                           // SEG_SEG_s1_agent:m0_debugaccess -> SEG_SEG_s1_translator:uav_debugaccess
	wire  [16:0] seg_seg_s1_agent_m0_address;                                               // SEG_SEG_s1_agent:m0_address -> SEG_SEG_s1_translator:uav_address
	wire   [3:0] seg_seg_s1_agent_m0_byteenable;                                            // SEG_SEG_s1_agent:m0_byteenable -> SEG_SEG_s1_translator:uav_byteenable
	wire         seg_seg_s1_agent_m0_read;                                                  // SEG_SEG_s1_agent:m0_read -> SEG_SEG_s1_translator:uav_read
	wire         seg_seg_s1_agent_m0_readdatavalid;                                         // SEG_SEG_s1_translator:uav_readdatavalid -> SEG_SEG_s1_agent:m0_readdatavalid
	wire         seg_seg_s1_agent_m0_lock;                                                  // SEG_SEG_s1_agent:m0_lock -> SEG_SEG_s1_translator:uav_lock
	wire  [31:0] seg_seg_s1_agent_m0_writedata;                                             // SEG_SEG_s1_agent:m0_writedata -> SEG_SEG_s1_translator:uav_writedata
	wire         seg_seg_s1_agent_m0_write;                                                 // SEG_SEG_s1_agent:m0_write -> SEG_SEG_s1_translator:uav_write
	wire   [2:0] seg_seg_s1_agent_m0_burstcount;                                            // SEG_SEG_s1_agent:m0_burstcount -> SEG_SEG_s1_translator:uav_burstcount
	wire         seg_seg_s1_agent_rf_source_valid;                                          // SEG_SEG_s1_agent:rf_source_valid -> SEG_SEG_s1_agent_rsp_fifo:in_valid
	wire  [95:0] seg_seg_s1_agent_rf_source_data;                                           // SEG_SEG_s1_agent:rf_source_data -> SEG_SEG_s1_agent_rsp_fifo:in_data
	wire         seg_seg_s1_agent_rf_source_ready;                                          // SEG_SEG_s1_agent_rsp_fifo:in_ready -> SEG_SEG_s1_agent:rf_source_ready
	wire         seg_seg_s1_agent_rf_source_startofpacket;                                  // SEG_SEG_s1_agent:rf_source_startofpacket -> SEG_SEG_s1_agent_rsp_fifo:in_startofpacket
	wire         seg_seg_s1_agent_rf_source_endofpacket;                                    // SEG_SEG_s1_agent:rf_source_endofpacket -> SEG_SEG_s1_agent_rsp_fifo:in_endofpacket
	wire         seg_seg_s1_agent_rsp_fifo_out_valid;                                       // SEG_SEG_s1_agent_rsp_fifo:out_valid -> SEG_SEG_s1_agent:rf_sink_valid
	wire  [95:0] seg_seg_s1_agent_rsp_fifo_out_data;                                        // SEG_SEG_s1_agent_rsp_fifo:out_data -> SEG_SEG_s1_agent:rf_sink_data
	wire         seg_seg_s1_agent_rsp_fifo_out_ready;                                       // SEG_SEG_s1_agent:rf_sink_ready -> SEG_SEG_s1_agent_rsp_fifo:out_ready
	wire         seg_seg_s1_agent_rsp_fifo_out_startofpacket;                               // SEG_SEG_s1_agent_rsp_fifo:out_startofpacket -> SEG_SEG_s1_agent:rf_sink_startofpacket
	wire         seg_seg_s1_agent_rsp_fifo_out_endofpacket;                                 // SEG_SEG_s1_agent_rsp_fifo:out_endofpacket -> SEG_SEG_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> SEG_SEG_s1_agent:cp_valid
	wire  [94:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> SEG_SEG_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // SEG_SEG_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> SEG_SEG_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> SEG_SEG_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> SEG_SEG_s1_agent:cp_endofpacket
	...
	wire         seg_switch_s1_agent_rp_valid;                                              // SEG_SWITCH_s1_agent:rp_valid -> router_009:sink_valid
	wire  [94:0] seg_switch_s1_agent_rp_data;                                               // SEG_SWITCH_s1_agent:rp_data -> router_009:sink_data
	wire         seg_switch_s1_agent_rp_ready;                                              // router_009:sink_ready -> SEG_SWITCH_s1_agent:rp_ready
	wire         seg_switch_s1_agent_rp_startofpacket;                                      // SEG_SWITCH_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         seg_switch_s1_agent_rp_endofpacket;                                        // SEG_SWITCH_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         seg_seg_s1_agent_rp_valid;                                                 // SEG_SEG_s1_agent:rp_valid -> router_010:sink_valid
	wire  [94:0] seg_seg_s1_agent_rp_data;                                                  // SEG_SEG_s1_agent:rp_data -> router_010:sink_data
	wire         seg_seg_s1_agent_rp_ready;                                                 // router_010:sink_ready -> SEG_SEG_s1_agent:rp_ready
	wire         seg_seg_s1_agent_rp_startofpacket;                                         // SEG_SEG_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         seg_seg_s1_agent_rp_endofpacket;                                           // SEG_SEG_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         seg_switch_s1_agent_rdata_fifo_src_valid;                                  // SEG_SWITCH_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] seg_switch_s1_agent_rdata_fifo_src_data;                                   // SEG_SWITCH_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         seg_switch_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_007:in_0_ready -> SEG_SWITCH_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                         // avalon_st_adapter_007:out_0_valid -> SEG_SWITCH_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                          // avalon_st_adapter_007:out_0_data -> SEG_SWITCH_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                         // SEG_SWITCH_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                         // avalon_st_adapter_007:out_0_error -> SEG_SWITCH_s1_agent:rdata_fifo_sink_error
	wire         seg_seg_s1_agent_rdata_fifo_src_valid;                                     // SEG_SEG_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] seg_seg_s1_agent_rdata_fifo_src_data;                                      // SEG_SEG_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         seg_seg_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_008:in_0_ready -> SEG_SEG_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                         // avalon_st_adapter_008:out_0_valid -> SEG_SEG_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                          // avalon_st_adapter_008:out_0_data -> SEG_SEG_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                         // SEG_SEG_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                         // avalon_st_adapter_008:out_0_error -> SEG_SEG_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) seg_switch_s1_translator (
		.clk                    (PLL_c0_clk),                            //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (seg_switch_s1_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (seg_switch_s1_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (seg_switch_s1_agent_m0_read),           //                         .read
		.uav_write              (seg_switch_s1_agent_m0_write),          //                         .write
		.uav_waitrequest        (seg_switch_s1_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (seg_switch_s1_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (seg_switch_s1_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (seg_switch_s1_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (seg_switch_s1_agent_m0_writedata),      //                         .writedata
		.uav_lock               (seg_switch_s1_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (seg_switch_s1_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (SEG_SWITCH_s1_address),                 //      avalon_anti_slave_0.address
		.av_write               (SEG_SWITCH_s1_write),                   //                         .write
		.av_readdata            (SEG_SWITCH_s1_readdata),                //                         .readdata
		.av_writedata           (SEG_SWITCH_s1_writedata),               //                         .writedata
		.av_chipselect          (SEG_SWITCH_s1_chipselect),              //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) seg_seg_s1_translator (
		.clk                    (PLL_c0_clk),                            //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (seg_seg_s1_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (seg_seg_s1_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (seg_seg_s1_agent_m0_read),              //                         .read
		.uav_write              (seg_seg_s1_agent_m0_write),             //                         .write
		.uav_waitrequest        (seg_seg_s1_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (seg_seg_s1_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (seg_seg_s1_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (seg_seg_s1_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (seg_seg_s1_agent_m0_writedata),         //                         .writedata
		.uav_lock               (seg_seg_s1_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (seg_seg_s1_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (SEG_SEG_s1_address),                    //      avalon_anti_slave_0.address
		.av_write               (SEG_SEG_s1_write),                      //                         .write
		.av_readdata            (SEG_SEG_s1_readdata),                   //                         .readdata
		.av_writedata           (SEG_SEG_s1_writedata),                  //                         .writedata
		.av_chipselect          (SEG_SEG_s1_chipselect),                 //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (PLL_c0_clk),                                     //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),          //       clk_reset.reset
		.m0_address              (seg_switch_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (seg_switch_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (seg_switch_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (seg_switch_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (seg_switch_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (seg_switch_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (seg_switch_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (seg_switch_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (seg_switch_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (seg_switch_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (seg_switch_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (seg_switch_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (seg_switch_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (seg_switch_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (seg_switch_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (seg_switch_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (seg_switch_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (seg_switch_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (seg_switch_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (seg_switch_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (seg_switch_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (seg_switch_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (seg_switch_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (seg_switch_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (seg_switch_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (seg_switch_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),              //                .error
		.rdata_fifo_src_ready    (seg_switch_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (seg_switch_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (seg_switch_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) seg_switch_s1_agent_rsp_fifo (
		.clk               (PLL_c0_clk),                                     //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (seg_switch_s1_agent_rf_source_data),             //        in.data
		.in_valid          (seg_switch_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (seg_switch_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (seg_switch_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (seg_switch_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (seg_switch_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (seg_switch_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (seg_switch_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (seg_switch_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (seg_switch_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (PLL_c0_clk),                                  //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (seg_seg_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (seg_seg_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (seg_seg_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (seg_seg_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (seg_seg_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (seg_seg_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (seg_seg_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (seg_seg_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (seg_seg_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (seg_seg_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (seg_seg_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (seg_seg_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (seg_seg_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (seg_seg_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (seg_seg_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (seg_seg_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (seg_seg_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (seg_seg_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (seg_seg_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (seg_seg_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (seg_seg_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (seg_seg_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (seg_seg_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (seg_seg_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (seg_seg_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (seg_seg_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),           //                .error
		.rdata_fifo_src_ready    (seg_seg_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (seg_seg_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (seg_seg_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) seg_seg_s1_agent_rsp_fifo (
		.clk               (PLL_c0_clk),                                  //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (seg_seg_s1_agent_rf_source_data),             //        in.data
		.in_valid          (seg_seg_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (seg_seg_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (seg_seg_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (seg_seg_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (seg_seg_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (seg_seg_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (seg_seg_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (seg_seg_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (seg_seg_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	tutorial01_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (seg_switch_s1_agent_rp_ready),          //      sink.ready
		.sink_valid         (seg_switch_s1_agent_rp_valid),          //          .valid
		.sink_data          (seg_switch_s1_agent_rp_data),           //          .data
		.sink_startofpacket (seg_switch_s1_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (seg_switch_s1_agent_rp_endofpacket),    //          .endofpacket
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial01_mm_interconnect_0_router_002 router_010 (
		.sink_ready         (seg_seg_s1_agent_rp_ready),             //      sink.ready
		.sink_valid         (seg_seg_s1_agent_rp_valid),             //          .valid
		.sink_data          (seg_seg_s1_agent_rp_data),              //          .data
		.sink_startofpacket (seg_seg_s1_agent_rp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (seg_seg_s1_agent_rp_endofpacket),       //          .endofpacket
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial01_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (PLL_c0_clk),                               // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (seg_switch_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (seg_switch_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (seg_switch_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	tutorial01_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (PLL_c0_clk),                            // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (seg_seg_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (seg_seg_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (seg_seg_s1_agent_rdata_fifo_src_ready), //         .ready
