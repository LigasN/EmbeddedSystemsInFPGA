...
`timescale 1 ps / 1 ps
module tutorial_mm_interconnect_0 (
		...
		output wire [0:0]  JATG_UART_avalon_jtag_slave_address,                   //                     JATG_UART_avalon_jtag_slave.address
		output wire        JATG_UART_avalon_jtag_slave_write,                     //                                                .write
		output wire        JATG_UART_avalon_jtag_slave_read,                      //                                                .read
		input  wire [31:0] JATG_UART_avalon_jtag_slave_readdata,                  //                                                .readdata
		output wire [31:0] JATG_UART_avalon_jtag_slave_writedata,                 //                                                .writedata
		input  wire        JATG_UART_avalon_jtag_slave_waitrequest,               //                                                .waitrequest
		output wire        JATG_UART_avalon_jtag_slave_chipselect,                //                                                .chipselect
		...
		output wire [1:0]  SD_DET_s1_address,                                     //                                       SD_DET_s1.address
		input  wire [31:0] SD_DET_s1_readdata,                                    //                                                .readdata
		...
		output wire [2:0]  SD_TIMER_s1_address,                                   //                                     SD_TIMER_s1.address
		output wire        SD_TIMER_s1_write,                                     //                                                .write
		input  wire [15:0] SD_TIMER_s1_readdata,                                  //                                                .readdata
		output wire [15:0] SD_TIMER_s1_writedata,                                 //                                                .writedata
		output wire        SD_TIMER_s1_chipselect,                                //                                                .chipselect
	...
	wire  [31:0] jatg_uart_avalon_jtag_slave_agent_m0_readdata;                             // JATG_UART_avalon_jtag_slave_translator:uav_readdata -> JATG_UART_avalon_jtag_slave_agent:m0_readdata
	wire         jatg_uart_avalon_jtag_slave_agent_m0_waitrequest;                          // JATG_UART_avalon_jtag_slave_translator:uav_waitrequest -> JATG_UART_avalon_jtag_slave_agent:m0_waitrequest
	wire         jatg_uart_avalon_jtag_slave_agent_m0_debugaccess;                          // JATG_UART_avalon_jtag_slave_agent:m0_debugaccess -> JATG_UART_avalon_jtag_slave_translator:uav_debugaccess
	wire  [16:0] jatg_uart_avalon_jtag_slave_agent_m0_address;                              // JATG_UART_avalon_jtag_slave_agent:m0_address -> JATG_UART_avalon_jtag_slave_translator:uav_address
	wire   [3:0] jatg_uart_avalon_jtag_slave_agent_m0_byteenable;                           // JATG_UART_avalon_jtag_slave_agent:m0_byteenable -> JATG_UART_avalon_jtag_slave_translator:uav_byteenable
	wire         jatg_uart_avalon_jtag_slave_agent_m0_read;                                 // JATG_UART_avalon_jtag_slave_agent:m0_read -> JATG_UART_avalon_jtag_slave_translator:uav_read
	wire         jatg_uart_avalon_jtag_slave_agent_m0_readdatavalid;                        // JATG_UART_avalon_jtag_slave_translator:uav_readdatavalid -> JATG_UART_avalon_jtag_slave_agent:m0_readdatavalid
	wire         jatg_uart_avalon_jtag_slave_agent_m0_lock;                                 // JATG_UART_avalon_jtag_slave_agent:m0_lock -> JATG_UART_avalon_jtag_slave_translator:uav_lock
	wire  [31:0] jatg_uart_avalon_jtag_slave_agent_m0_writedata;                            // JATG_UART_avalon_jtag_slave_agent:m0_writedata -> JATG_UART_avalon_jtag_slave_translator:uav_writedata
	wire         jatg_uart_avalon_jtag_slave_agent_m0_write;                                // JATG_UART_avalon_jtag_slave_agent:m0_write -> JATG_UART_avalon_jtag_slave_translator:uav_write
	wire   [2:0] jatg_uart_avalon_jtag_slave_agent_m0_burstcount;                           // JATG_UART_avalon_jtag_slave_agent:m0_burstcount -> JATG_UART_avalon_jtag_slave_translator:uav_burstcount
	wire         jatg_uart_avalon_jtag_slave_agent_rf_source_valid;                         // JATG_UART_avalon_jtag_slave_agent:rf_source_valid -> JATG_UART_avalon_jtag_slave_agent_rsp_fifo:in_valid
	wire  [95:0] jatg_uart_avalon_jtag_slave_agent_rf_source_data;                          // JATG_UART_avalon_jtag_slave_agent:rf_source_data -> JATG_UART_avalon_jtag_slave_agent_rsp_fifo:in_data
	wire         jatg_uart_avalon_jtag_slave_agent_rf_source_ready;                         // JATG_UART_avalon_jtag_slave_agent_rsp_fifo:in_ready -> JATG_UART_avalon_jtag_slave_agent:rf_source_ready
	wire         jatg_uart_avalon_jtag_slave_agent_rf_source_startofpacket;                 // JATG_UART_avalon_jtag_slave_agent:rf_source_startofpacket -> JATG_UART_avalon_jtag_slave_agent_rsp_fifo:in_startofpacket
	wire         jatg_uart_avalon_jtag_slave_agent_rf_source_endofpacket;                   // JATG_UART_avalon_jtag_slave_agent:rf_source_endofpacket -> JATG_UART_avalon_jtag_slave_agent_rsp_fifo:in_endofpacket
	wire         jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_valid;                      // JATG_UART_avalon_jtag_slave_agent_rsp_fifo:out_valid -> JATG_UART_avalon_jtag_slave_agent:rf_sink_valid
	wire  [95:0] jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_data;                       // JATG_UART_avalon_jtag_slave_agent_rsp_fifo:out_data -> JATG_UART_avalon_jtag_slave_agent:rf_sink_data
	wire         jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_ready;                      // JATG_UART_avalon_jtag_slave_agent:rf_sink_ready -> JATG_UART_avalon_jtag_slave_agent_rsp_fifo:out_ready
	wire         jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_startofpacket;              // JATG_UART_avalon_jtag_slave_agent_rsp_fifo:out_startofpacket -> JATG_UART_avalon_jtag_slave_agent:rf_sink_startofpacket
	wire         jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_endofpacket;                // JATG_UART_avalon_jtag_slave_agent_rsp_fifo:out_endofpacket -> JATG_UART_avalon_jtag_slave_agent:rf_sink_endofpacket
	wire         cmd_mux_src_valid;                                                         // cmd_mux:src_valid -> JATG_UART_avalon_jtag_slave_agent:cp_valid
	wire  [94:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> JATG_UART_avalon_jtag_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                         // JATG_UART_avalon_jtag_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [9:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> JATG_UART_avalon_jtag_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                 // cmd_mux:src_startofpacket -> JATG_UART_avalon_jtag_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                   // cmd_mux:src_endofpacket -> JATG_UART_avalon_jtag_slave_agent:cp_endofpacket
	...
	wire         cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> CPU_ID_control_slave_agent:cp_valid
	wire  [94:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> CPU_ID_control_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // CPU_ID_control_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [9:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> CPU_ID_control_slave_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> CPU_ID_control_slave_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> CPU_ID_control_slave_agent:cp_endofpacket
	...
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> TIMER0_s1_agent:cp_valid
	wire  [94:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> TIMER0_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // TIMER0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [9:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> TIMER0_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> TIMER0_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> TIMER0_s1_agent:cp_endofpacket
	wire  [31:0] sd_timer_s1_agent_m0_readdata;                                             // SD_TIMER_s1_translator:uav_readdata -> SD_TIMER_s1_agent:m0_readdata
	wire         sd_timer_s1_agent_m0_waitrequest;                                          // SD_TIMER_s1_translator:uav_waitrequest -> SD_TIMER_s1_agent:m0_waitrequest
	wire         sd_timer_s1_agent_m0_debugaccess;                                          // SD_TIMER_s1_agent:m0_debugaccess -> SD_TIMER_s1_translator:uav_debugaccess
	wire  [16:0] sd_timer_s1_agent_m0_address;                                              // SD_TIMER_s1_agent:m0_address -> SD_TIMER_s1_translator:uav_address
	wire   [3:0] sd_timer_s1_agent_m0_byteenable;                                           // SD_TIMER_s1_agent:m0_byteenable -> SD_TIMER_s1_translator:uav_byteenable
	wire         sd_timer_s1_agent_m0_read;                                                 // SD_TIMER_s1_agent:m0_read -> SD_TIMER_s1_translator:uav_read
	wire         sd_timer_s1_agent_m0_readdatavalid;                                        // SD_TIMER_s1_translator:uav_readdatavalid -> SD_TIMER_s1_agent:m0_readdatavalid
	wire         sd_timer_s1_agent_m0_lock;                                                 // SD_TIMER_s1_agent:m0_lock -> SD_TIMER_s1_translator:uav_lock
	wire  [31:0] sd_timer_s1_agent_m0_writedata;                                            // SD_TIMER_s1_agent:m0_writedata -> SD_TIMER_s1_translator:uav_writedata
	wire         sd_timer_s1_agent_m0_write;                                                // SD_TIMER_s1_agent:m0_write -> SD_TIMER_s1_translator:uav_write
	wire   [2:0] sd_timer_s1_agent_m0_burstcount;                                           // SD_TIMER_s1_agent:m0_burstcount -> SD_TIMER_s1_translator:uav_burstcount
	wire         sd_timer_s1_agent_rf_source_valid;                                         // SD_TIMER_s1_agent:rf_source_valid -> SD_TIMER_s1_agent_rsp_fifo:in_valid
	wire  [95:0] sd_timer_s1_agent_rf_source_data;                                          // SD_TIMER_s1_agent:rf_source_data -> SD_TIMER_s1_agent_rsp_fifo:in_data
	wire         sd_timer_s1_agent_rf_source_ready;                                         // SD_TIMER_s1_agent_rsp_fifo:in_ready -> SD_TIMER_s1_agent:rf_source_ready
	wire         sd_timer_s1_agent_rf_source_startofpacket;                                 // SD_TIMER_s1_agent:rf_source_startofpacket -> SD_TIMER_s1_agent_rsp_fifo:in_startofpacket
	wire         sd_timer_s1_agent_rf_source_endofpacket;                                   // SD_TIMER_s1_agent:rf_source_endofpacket -> SD_TIMER_s1_agent_rsp_fifo:in_endofpacket
	wire         sd_timer_s1_agent_rsp_fifo_out_valid;                                      // SD_TIMER_s1_agent_rsp_fifo:out_valid -> SD_TIMER_s1_agent:rf_sink_valid
	wire  [95:0] sd_timer_s1_agent_rsp_fifo_out_data;                                       // SD_TIMER_s1_agent_rsp_fifo:out_data -> SD_TIMER_s1_agent:rf_sink_data
	wire         sd_timer_s1_agent_rsp_fifo_out_ready;                                      // SD_TIMER_s1_agent:rf_sink_ready -> SD_TIMER_s1_agent_rsp_fifo:out_ready
	wire         sd_timer_s1_agent_rsp_fifo_out_startofpacket;                              // SD_TIMER_s1_agent_rsp_fifo:out_startofpacket -> SD_TIMER_s1_agent:rf_sink_startofpacket
	wire         sd_timer_s1_agent_rsp_fifo_out_endofpacket;                                // SD_TIMER_s1_agent_rsp_fifo:out_endofpacket -> SD_TIMER_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> SD_TIMER_s1_agent:cp_valid
	wire  [94:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> SD_TIMER_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // SD_TIMER_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> SD_TIMER_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> SD_TIMER_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> SD_TIMER_s1_agent:cp_endofpacket
	wire  [31:0] sd_det_s1_agent_m0_readdata;                                               // SD_DET_s1_translator:uav_readdata -> SD_DET_s1_agent:m0_readdata
	wire         sd_det_s1_agent_m0_waitrequest;                                            // SD_DET_s1_translator:uav_waitrequest -> SD_DET_s1_agent:m0_waitrequest
	wire         sd_det_s1_agent_m0_debugaccess;                                            // SD_DET_s1_agent:m0_debugaccess -> SD_DET_s1_translator:uav_debugaccess
	wire  [16:0] sd_det_s1_agent_m0_address;                                                // SD_DET_s1_agent:m0_address -> SD_DET_s1_translator:uav_address
	wire   [3:0] sd_det_s1_agent_m0_byteenable;                                             // SD_DET_s1_agent:m0_byteenable -> SD_DET_s1_translator:uav_byteenable
	wire         sd_det_s1_agent_m0_read;                                                   // SD_DET_s1_agent:m0_read -> SD_DET_s1_translator:uav_read
	wire         sd_det_s1_agent_m0_readdatavalid;                                          // SD_DET_s1_translator:uav_readdatavalid -> SD_DET_s1_agent:m0_readdatavalid
	wire         sd_det_s1_agent_m0_lock;                                                   // SD_DET_s1_agent:m0_lock -> SD_DET_s1_translator:uav_lock
	wire  [31:0] sd_det_s1_agent_m0_writedata;                                              // SD_DET_s1_agent:m0_writedata -> SD_DET_s1_translator:uav_writedata
	wire         sd_det_s1_agent_m0_write;                                                  // SD_DET_s1_agent:m0_write -> SD_DET_s1_translator:uav_write
	wire   [2:0] sd_det_s1_agent_m0_burstcount;                                             // SD_DET_s1_agent:m0_burstcount -> SD_DET_s1_translator:uav_burstcount
	wire         sd_det_s1_agent_rf_source_valid;                                           // SD_DET_s1_agent:rf_source_valid -> SD_DET_s1_agent_rsp_fifo:in_valid
	wire  [95:0] sd_det_s1_agent_rf_source_data;                                            // SD_DET_s1_agent:rf_source_data -> SD_DET_s1_agent_rsp_fifo:in_data
	wire         sd_det_s1_agent_rf_source_ready;                                           // SD_DET_s1_agent_rsp_fifo:in_ready -> SD_DET_s1_agent:rf_source_ready
	wire         sd_det_s1_agent_rf_source_startofpacket;                                   // SD_DET_s1_agent:rf_source_startofpacket -> SD_DET_s1_agent_rsp_fifo:in_startofpacket
	wire         sd_det_s1_agent_rf_source_endofpacket;                                     // SD_DET_s1_agent:rf_source_endofpacket -> SD_DET_s1_agent_rsp_fifo:in_endofpacket
	wire         sd_det_s1_agent_rsp_fifo_out_valid;                                        // SD_DET_s1_agent_rsp_fifo:out_valid -> SD_DET_s1_agent:rf_sink_valid
	wire  [95:0] sd_det_s1_agent_rsp_fifo_out_data;                                         // SD_DET_s1_agent_rsp_fifo:out_data -> SD_DET_s1_agent:rf_sink_data
	wire         sd_det_s1_agent_rsp_fifo_out_ready;                                        // SD_DET_s1_agent:rf_sink_ready -> SD_DET_s1_agent_rsp_fifo:out_ready
	wire         sd_det_s1_agent_rsp_fifo_out_startofpacket;                                // SD_DET_s1_agent_rsp_fifo:out_startofpacket -> SD_DET_s1_agent:rf_sink_startofpacket
	wire         sd_det_s1_agent_rsp_fifo_out_endofpacket;                                  // SD_DET_s1_agent_rsp_fifo:out_endofpacket -> SD_DET_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> SD_DET_s1_agent:cp_valid
	wire  [94:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> SD_DET_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // SD_DET_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> SD_DET_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> SD_DET_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> SD_DET_s1_agent:cp_endofpacket
	...
	wire  [16:0] sd_spi_spi_control_port_agent_m0_address;                                  // SD_SPI_spi_control_port_agent:m0_address -> SD_SPI_spi_control_port_translator:uav_address
	...
	wire  [95:0] sd_spi_spi_control_port_agent_rf_source_data;                              // SD_SPI_spi_control_port_agent:rf_source_data -> SD_SPI_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [95:0] sd_spi_spi_control_port_agent_rsp_fifo_out_data;                           // SD_SPI_spi_control_port_agent_rsp_fifo:out_data -> SD_SPI_spi_control_port_agent:rf_sink_data
	...
	wire         cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> SD_SPI_spi_control_port_agent:cp_valid
	wire  [94:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> SD_SPI_spi_control_port_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                     // SD_SPI_spi_control_port_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> SD_SPI_spi_control_port_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> SD_SPI_spi_control_port_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> SD_SPI_spi_control_port_agent:cp_endofpacket
	...
	wire         jatg_uart_avalon_jtag_slave_agent_rp_valid;                                // JATG_UART_avalon_jtag_slave_agent:rp_valid -> router_002:sink_valid
	wire  [94:0] jatg_uart_avalon_jtag_slave_agent_rp_data;                                 // JATG_UART_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	wire         jatg_uart_avalon_jtag_slave_agent_rp_ready;                                // router_002:sink_ready -> JATG_UART_avalon_jtag_slave_agent:rp_ready
	wire         jatg_uart_avalon_jtag_slave_agent_rp_startofpacket;                        // JATG_UART_avalon_jtag_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         jatg_uart_avalon_jtag_slave_agent_rp_endofpacket;                          // JATG_UART_avalon_jtag_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         cpu_id_control_slave_agent_rp_valid;                                       // CPU_ID_control_slave_agent:rp_valid -> router_003:sink_valid
	wire  [94:0] cpu_id_control_slave_agent_rp_data;                                        // CPU_ID_control_slave_agent:rp_data -> router_003:sink_data
	wire         cpu_id_control_slave_agent_rp_ready;                                       // router_003:sink_ready -> CPU_ID_control_slave_agent:rp_ready
	wire         cpu_id_control_slave_agent_rp_startofpacket;                               // CPU_ID_control_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         cpu_id_control_slave_agent_rp_endofpacket;                                 // CPU_ID_control_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         timer0_s1_agent_rp_valid;                                                  // TIMER0_s1_agent:rp_valid -> router_008:sink_valid
	wire  [94:0] timer0_s1_agent_rp_data;                                                   // TIMER0_s1_agent:rp_data -> router_008:sink_data
	wire         timer0_s1_agent_rp_ready;                                                  // router_008:sink_ready -> TIMER0_s1_agent:rp_ready
	wire         timer0_s1_agent_rp_startofpacket;                                          // TIMER0_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         timer0_s1_agent_rp_endofpacket;                                            // TIMER0_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         sd_timer_s1_agent_rp_valid;                                                // SD_TIMER_s1_agent:rp_valid -> router_009:sink_valid
	wire  [94:0] sd_timer_s1_agent_rp_data;                                                 // SD_TIMER_s1_agent:rp_data -> router_009:sink_data
	wire         sd_timer_s1_agent_rp_ready;                                                // router_009:sink_ready -> SD_TIMER_s1_agent:rp_ready
	wire         sd_timer_s1_agent_rp_startofpacket;                                        // SD_TIMER_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         sd_timer_s1_agent_rp_endofpacket;                                          // SD_TIMER_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         sd_det_s1_agent_rp_valid;                                                  // SD_DET_s1_agent:rp_valid -> router_010:sink_valid
	wire  [94:0] sd_det_s1_agent_rp_data;                                                   // SD_DET_s1_agent:rp_data -> router_010:sink_data
	wire         sd_det_s1_agent_rp_ready;                                                  // router_010:sink_ready -> SD_DET_s1_agent:rp_ready
	wire         sd_det_s1_agent_rp_startofpacket;                                          // SD_DET_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         sd_det_s1_agent_rp_endofpacket;                                            // SD_DET_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         sd_spi_spi_control_port_agent_rp_valid;                                    // SD_SPI_spi_control_port_agent:rp_valid -> router_011:sink_valid
	wire  [94:0] sd_spi_spi_control_port_agent_rp_data;                                     // SD_SPI_spi_control_port_agent:rp_data -> router_011:sink_data
	wire         sd_spi_spi_control_port_agent_rp_ready;                                    // router_011:sink_ready -> SD_SPI_spi_control_port_agent:rp_ready
	wire         sd_spi_spi_control_port_agent_rp_startofpacket;                            // SD_SPI_spi_control_port_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         sd_spi_spi_control_port_agent_rp_endofpacket;                              // SD_SPI_spi_control_port_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire         jatg_uart_avalon_jtag_slave_agent_rdata_fifo_src_valid;                    // JATG_UART_avalon_jtag_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] jatg_uart_avalon_jtag_slave_agent_rdata_fifo_src_data;                     // JATG_UART_avalon_jtag_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         jatg_uart_avalon_jtag_slave_agent_rdata_fifo_src_ready;                    // avalon_st_adapter:in_0_ready -> JATG_UART_avalon_jtag_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                             // avalon_st_adapter:out_0_valid -> JATG_UART_avalon_jtag_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                              // avalon_st_adapter:out_0_data -> JATG_UART_avalon_jtag_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                             // JATG_UART_avalon_jtag_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                             // avalon_st_adapter:out_0_error -> JATG_UART_avalon_jtag_slave_agent:rdata_fifo_sink_error
	wire         cpu_id_control_slave_agent_rdata_fifo_src_valid;                           // CPU_ID_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] cpu_id_control_slave_agent_rdata_fifo_src_data;                            // CPU_ID_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         cpu_id_control_slave_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_001:in_0_ready -> CPU_ID_control_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> CPU_ID_control_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> CPU_ID_control_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                         // CPU_ID_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> CPU_ID_control_slave_agent:rdata_fifo_sink_error
	...
	wire         timer0_s1_agent_rdata_fifo_src_valid;                                      // TIMER0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] timer0_s1_agent_rdata_fifo_src_data;                                       // TIMER0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         timer0_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_006:in_0_ready -> TIMER0_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> TIMER0_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> TIMER0_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // TIMER0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> TIMER0_s1_agent:rdata_fifo_sink_error
	wire         sd_timer_s1_agent_rdata_fifo_src_valid;                                    // SD_TIMER_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] sd_timer_s1_agent_rdata_fifo_src_data;                                     // SD_TIMER_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         sd_timer_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_007:in_0_ready -> SD_TIMER_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                         // avalon_st_adapter_007:out_0_valid -> SD_TIMER_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                          // avalon_st_adapter_007:out_0_data -> SD_TIMER_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                         // SD_TIMER_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                         // avalon_st_adapter_007:out_0_error -> SD_TIMER_s1_agent:rdata_fifo_sink_error
	wire         sd_det_s1_agent_rdata_fifo_src_valid;                                      // SD_DET_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] sd_det_s1_agent_rdata_fifo_src_data;                                       // SD_DET_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         sd_det_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_008:in_0_ready -> SD_DET_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                         // avalon_st_adapter_008:out_0_valid -> SD_DET_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                          // avalon_st_adapter_008:out_0_data -> SD_DET_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                         // SD_DET_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                         // avalon_st_adapter_008:out_0_error -> SD_DET_s1_agent:rdata_fifo_sink_error
	wire         sd_spi_spi_control_port_agent_rdata_fifo_src_valid;                        // SD_SPI_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] sd_spi_spi_control_port_agent_rdata_fifo_src_data;                         // SD_SPI_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         sd_spi_spi_control_port_agent_rdata_fifo_src_ready;                        // avalon_st_adapter_009:in_0_ready -> SD_SPI_spi_control_port_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                         // avalon_st_adapter_009:out_0_valid -> SD_SPI_spi_control_port_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                          // avalon_st_adapter_009:out_0_data -> SD_SPI_spi_control_port_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                         // SD_SPI_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                         // avalon_st_adapter_009:out_0_error -> SD_SPI_spi_control_port_agent:rdata_fifo_sink_error
	...
	) jatg_uart_avalon_jtag_slave_translator (
		.clk                    (PLL_c0_clk),                                         //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset),              //                    reset.reset
		.uav_address            (jatg_uart_avalon_jtag_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (jatg_uart_avalon_jtag_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (jatg_uart_avalon_jtag_slave_agent_m0_read),          //                         .read
		.uav_write              (jatg_uart_avalon_jtag_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (jatg_uart_avalon_jtag_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (jatg_uart_avalon_jtag_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (jatg_uart_avalon_jtag_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (jatg_uart_avalon_jtag_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (jatg_uart_avalon_jtag_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (jatg_uart_avalon_jtag_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (jatg_uart_avalon_jtag_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (JATG_UART_avalon_jtag_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (JATG_UART_avalon_jtag_slave_write),                  //                         .write
		.av_read                (JATG_UART_avalon_jtag_slave_read),                   //                         .read
		.av_readdata            (JATG_UART_avalon_jtag_slave_readdata),               //                         .readdata
		.av_writedata           (JATG_UART_avalon_jtag_slave_writedata),              //                         .writedata
		.av_waitrequest         (JATG_UART_avalon_jtag_slave_waitrequest),            //                         .waitrequest
		.av_chipselect          (JATG_UART_avalon_jtag_slave_chipselect),             //                         .chipselect
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sd_timer_s1_translator (
		.clk                    (PLL_c0_clk),                            //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sd_timer_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (sd_timer_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (sd_timer_s1_agent_m0_read),             //                         .read
		.uav_write              (sd_timer_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (sd_timer_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (sd_timer_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (sd_timer_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (sd_timer_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (sd_timer_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (sd_timer_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (sd_timer_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (SD_TIMER_s1_address),                   //      avalon_anti_slave_0.address
		.av_write               (SD_TIMER_s1_write),                     //                         .write
		.av_readdata            (SD_TIMER_s1_readdata),                  //                         .readdata
		.av_writedata           (SD_TIMER_s1_writedata),                 //                         .writedata
		.av_chipselect          (SD_TIMER_s1_chipselect),                //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sd_det_s1_translator (
		.clk                    (PLL_c0_clk),                            //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sd_det_s1_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (sd_det_s1_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (sd_det_s1_agent_m0_read),               //                         .read
		.uav_write              (sd_det_s1_agent_m0_write),              //                         .write
		.uav_waitrequest        (sd_det_s1_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (sd_det_s1_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (sd_det_s1_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (sd_det_s1_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (sd_det_s1_agent_m0_writedata),          //                         .writedata
		.uav_lock               (sd_det_s1_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (sd_det_s1_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (SD_DET_s1_address),                     //      avalon_anti_slave_0.address
		.av_readdata            (SD_DET_s1_readdata),                    //                         .readdata
		.av_write               (),                                      //              (terminated)
		.av_read                (),                                      //              (terminated)
		.av_writedata           (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) jatg_uart_avalon_jtag_slave_agent (
		.clk                     (PLL_c0_clk),                                                   //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),                        //       clk_reset.reset
		.m0_address              (jatg_uart_avalon_jtag_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (jatg_uart_avalon_jtag_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (jatg_uart_avalon_jtag_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (jatg_uart_avalon_jtag_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (jatg_uart_avalon_jtag_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (jatg_uart_avalon_jtag_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (jatg_uart_avalon_jtag_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (jatg_uart_avalon_jtag_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (jatg_uart_avalon_jtag_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (jatg_uart_avalon_jtag_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (jatg_uart_avalon_jtag_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (jatg_uart_avalon_jtag_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (jatg_uart_avalon_jtag_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (jatg_uart_avalon_jtag_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (jatg_uart_avalon_jtag_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (jatg_uart_avalon_jtag_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (jatg_uart_avalon_jtag_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (jatg_uart_avalon_jtag_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (jatg_uart_avalon_jtag_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (jatg_uart_avalon_jtag_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (jatg_uart_avalon_jtag_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                                //                .error
		.rdata_fifo_src_ready    (jatg_uart_avalon_jtag_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (jatg_uart_avalon_jtag_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (jatg_uart_avalon_jtag_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) jatg_uart_avalon_jtag_slave_agent_rsp_fifo (
		.clk               (PLL_c0_clk),                                                   //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),                        // clk_reset.reset
		.in_data           (jatg_uart_avalon_jtag_slave_agent_rf_source_data),             //        in.data
		.in_valid          (jatg_uart_avalon_jtag_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (jatg_uart_avalon_jtag_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (jatg_uart_avalon_jtag_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (jatg_uart_avalon_jtag_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (jatg_uart_avalon_jtag_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (PLL_c0_clk),                                   //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (sd_timer_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (sd_timer_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (sd_timer_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (sd_timer_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (sd_timer_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (sd_timer_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (sd_timer_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (sd_timer_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (sd_timer_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (sd_timer_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (sd_timer_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (sd_timer_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (sd_timer_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (sd_timer_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (sd_timer_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (sd_timer_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (sd_timer_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (sd_timer_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (sd_timer_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (sd_timer_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (sd_timer_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (sd_timer_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (sd_timer_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (sd_timer_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (sd_timer_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (sd_timer_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),            //                .error
		.rdata_fifo_src_ready    (sd_timer_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sd_timer_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (sd_timer_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sd_timer_s1_agent_rsp_fifo (
		.clk               (PLL_c0_clk),                                   //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (sd_timer_s1_agent_rf_source_data),             //        in.data
		.in_valid          (sd_timer_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (sd_timer_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sd_timer_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sd_timer_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sd_timer_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sd_timer_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sd_timer_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sd_timer_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sd_timer_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (PLL_c0_clk),                                 //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (sd_det_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (sd_det_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (sd_det_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (sd_det_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (sd_det_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (sd_det_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (sd_det_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (sd_det_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (sd_det_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (sd_det_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (sd_det_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (sd_det_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (sd_det_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (sd_det_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (sd_det_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (sd_det_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (sd_det_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (sd_det_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (sd_det_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (sd_det_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (sd_det_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (sd_det_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (sd_det_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (sd_det_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (sd_det_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (sd_det_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),          //                .error
		.rdata_fifo_src_ready    (sd_det_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sd_det_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (sd_det_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sd_det_s1_agent_rsp_fifo (
		.clk               (PLL_c0_clk),                                 //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (sd_det_s1_agent_rf_source_data),             //        in.data
		.in_valid          (sd_det_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (sd_det_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sd_det_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sd_det_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sd_det_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sd_det_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sd_det_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sd_det_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sd_det_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	tutorial_mm_interconnect_0_router router (
	...
	tutorial_mm_interconnect_0_router_001 router_001 (
	...
	tutorial_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (jatg_uart_avalon_jtag_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (jatg_uart_avalon_jtag_slave_agent_rp_valid),         //          .valid
		.sink_data          (jatg_uart_avalon_jtag_slave_agent_rp_data),          //          .data
		.sink_startofpacket (jatg_uart_avalon_jtag_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (jatg_uart_avalon_jtag_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (PLL_c0_clk),                                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),              // clk_reset.reset
	...
	tutorial_mm_interconnect_0_router_002 router_003 (
	...
	tutorial_mm_interconnect_0_router_004 router_004 (
	...
	tutorial_mm_interconnect_0_router_002 router_005 (
	...
	tutorial_mm_interconnect_0_router_004 router_006 (
	...
	tutorial_mm_interconnect_0_router_002 router_007 (
	...
	tutorial_mm_interconnect_0_router_002 router_008 (
	...
	tutorial_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (sd_timer_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (sd_timer_s1_agent_rp_valid),            //          .valid
		.sink_data          (sd_timer_s1_agent_rp_data),             //          .data
		.sink_startofpacket (sd_timer_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (sd_timer_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_router_002 router_010 (
		.sink_ready         (sd_det_s1_agent_rp_ready),              //      sink.ready
		.sink_valid         (sd_det_s1_agent_rp_valid),              //          .valid
		.sink_data          (sd_det_s1_agent_rp_data),               //          .data
		.sink_startofpacket (sd_det_s1_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (sd_det_s1_agent_rp_endofpacket),        //          .endofpacket
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_router_002 router_011 (
	...
	tutorial_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (CLK_clk_clk),                                           //       clk.clk
		.reset               (PLL_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (CLK_clk_clk),                                           //       clk.clk
		.reset              (PLL_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (PLL_c0_clk),                            //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (PLL_c0_clk),                            //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tutorial_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_0_data      (jatg_uart_avalon_jtag_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (jatg_uart_avalon_jtag_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (jatg_uart_avalon_jtag_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	tutorial_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (PLL_c0_clk),                             // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (sd_timer_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (sd_timer_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (sd_timer_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	tutorial_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (PLL_c0_clk),                            // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sd_det_s1_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (sd_det_s1_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (sd_det_s1_agent_rdata_fifo_src_ready),  //         .ready
